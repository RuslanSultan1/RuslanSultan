...
import static enums.HeaderSection.*;
import static enums.IconsTexts.*;
...
public class PageObjectTest extends SeleniumBase {
    ...
    public void pageObjectTest() {
        ...
        indexPage.checkTitle(driver, INDEX_PAGE_TITLE);
        ...
        indexPage.checkHeaderSection(HOME, CONTACT_FORM, SERVICE, METALS_COLORS);
